...
CREATE TABLE IF NOT EXISTS analytics.liquidity_snapshots (
    ...
    liquidity_value DECIMAL(20,8) NOT NULL, -- price * quantity (normalized)
...
CREATE TABLE IF NOT EXISTS analytics.liquidity_snapshots_aggregated (
    ...
    pool_id TEXT NOT NULL,
    symbol TEXT NOT NULL,
    bid_liquidity DECIMAL(20,8) NOT NULL DEFAULT 0,
    ask_liquidity DECIMAL(20,8) NOT NULL DEFAULT 0,
