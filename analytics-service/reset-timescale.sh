...
echo "      → 04_liquidity_snapshots.sql (historical liquidity tracking tables)"
echo "      → 05_leaderboard_infrastructure.sql (PNL tables and infrastructure)"
echo "      → 06_leaderboard_validation.sql (validation tools and monitoring)"
echo "      → 07_ensure_30d_leaderboard_coverage.sql (30d leaderboard coverage fix)"
echo ""
echo "🧹 State Reset:"
